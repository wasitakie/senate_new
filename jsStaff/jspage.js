...
$(".btnsub").submit(function () {
  ...
  if ($(".q2-12:checked").length == "") {
    alert(
      "2.12 ตั้งแต่เริ่มทำงานจนถึงปัจจุบัน ท่านลาออก/ย้าย/เปลี่ยนงานมาแล้วกี่ครั้ง"
    );
    $("#checkq2-12-1").focus();
    return false;
  }
  ...
  if ($(".q2-13:checked").length == "") {
    alert(
      "2.13 ท่านมีรายได้ต่อเดือน โดยประมาณเดือนละเท่าใด (รายได้+เงินเดือน+ค่าตอบแทนอื่น ๆ)"
    );
    $("#checkq2-13-1").focus();
    return false;
  }
