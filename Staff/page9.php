    ...
    <div class="container manu">
        <div class="col-md-12">
            ...
            <form action="page9Insert.php" method="post" class="btnsub">
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ">41. งานของท่าน
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ">43.
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ">44. ในการทำงาน
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ">45. ท่านได้รับ
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ">46.
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ">47. ความถูกต้อง
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ">48. ความตรงเวลา
                                ของการจ่ายค่าจ้าง ค่าล่วงเวลา ฯลฯ
                                ที่ท่านได้รับจากองค์กรของท่านเป็นอย่างไร</span></label>
                        <div class="form-check">
